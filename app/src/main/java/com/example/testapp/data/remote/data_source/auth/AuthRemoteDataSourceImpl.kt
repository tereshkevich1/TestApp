...
class AuthRemoteDataSourceImpl @Inject constructor(private val api: AuthApi) :
    ...
    override suspend fun signUp(signUserDtoIn: SignUserDtoIn): NetworkResult<SignUserOutDto> = withContext(Dispatchers.IO){
        handleApi (
    ...
    override suspend fun signIn(signUserDtoIn: SignUserDtoIn): NetworkResult<SignUserOutDto> = withContext(Dispatchers.IO){
        handleApi (
